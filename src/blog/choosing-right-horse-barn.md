...
seoTitle: "Horse Barn Design: Sizes, Stalls & Layout"
description: "Horse barn design guide for Michigan: stall sizes, aisle widths, ventilation, and layouts that keep horses healthy through cold winters and humid summers."
date: 2025-03-05
category: "Tips"
image: "/images/projects/pole-barn-interior-breezeway.jpg"
excerpt: "Start with a 12-by-12 stall per horse and a 12-foot aisle, then size the barn around stall count plus tack, feed, and hay space. Here's the full design math for a Michigan horse barn."
...
tags:
  ...
  - "Michigan"
faq:
  - q: "What size stall does a horse need?"
    a: "12 by 12 feet is the working minimum for an average-sized horse. Draft horses, warmbloods, and other large breeds do better in 14-by-14 or 12-by-16 stalls that give them room to lie down and turn around. Undersized stalls are the design mistake horse owners regret most, and they're the hardest one to fix later."
  - q: "How big a barn do I need for 2 to 4 horses?"
    a: "A four-stall center-aisle barn with a tack room and feed room runs about 36 by 48 feet. Two horses fit a shorter version of the same footprint, but most owners keep the extra stalls for hay, storage, or a future horse. Add roughly 12 feet of length if you want a wash stall."
  - q: "What does a horse barn cost to build?"
    a: "The shell is the smaller part of it. Stall count, stall fronts and hardware, rubber mats, plumbing for a wash stall, a climate-controlled tack room, concrete, and site work are what move the number. Two barns with the same footprint can price out very differently. We'll price your exact layout with a free estimate."
---
...
For most Michigan horse owners, a center-aisle [pole barn](/services/horse-barns/) is the best balance of function, weather protection, and cost. If your plans include an indoor riding arena, that's a clear-span steel building, and we quote those too as a certified Federal Steel Systems dealer. Our [arena page](/steel-buildings/arenas/) covers what those frames can do.
